...
def converting():
    ...
    def get():
        ...
        def CONVERT():
            ...
            class voice_conversion:
                ...
                def train(self):
                    for epoch in range(self.start_epoch, self.num_epochs):
                        ...
                        dis = "Epoch: {} , Time for epoch: {:.2f} sec".format(epoch, end_time - start_time_epoch)
                        self.store_to_file(store_to_file)
                        print("Epoch: {} , Time taken : {:.2f}\n".format(epoch, end_time - start_time_epoch))

                        label2 = Label(voice_conversion_page, text=dis)
                        label2.configure(background=B_color)
                        label2.configure(foreground=F_color)
                        label2.config(font=("Times new roman", 15))
            ...
            # train_A_dir = './Users/nehajadhavsarnaik/Documents/NEHA\ WORK/MASTERS\ SUBJECTS\ /COMPUTER\ SCIENCE/CS767/VC/data/in_samples'
            train_A_dir = '/Users/nehajadhavsarnaik/Desktop/NEHA WORK/MASTERS SUBJECTS /COMPUTER SCIENCE/CS767/VC/data/in_samples'
            train_B_dir = '/Users/nehajadhavsarnaik/Desktop/NEHA WORK/MASTERS SUBJECTS /COMPUTER SCIENCE/CS767/VC/data/out_samples'
            # train_B_dir = './Users/nehajadhavsarnaik/Documents/NEHA\ WORK/MASTERS\ SUBJECTS\ /COMPUTER\ SCIENCE/CS767/VC/data/out_samples'
            out_folder = './data/'
            ...
            # validation_dir = './Users/nehajadhavsarnaik/Documents/NEHA\ WORK/MASTERS\ SUBJECTS\ /COMPUTER\ SCIENCE/CS767/VC/data/out_samples'
            validation_dir = '/Users/nehajadhavsarnaik/Desktop/NEHA WORK/MASTERS SUBJECTS /COMPUTER SCIENCE/CS767/VC/data/out_samples'
            # output_dir = './Users/nehajadhavsarnaik/Documents/NEHA\ WORK/MASTERS\ SUBJECTS\ /COMPUTER\ SCIENCE/CS767/VC/data/out_samples'
            output_dir = '/Users/nehajadhavsarnaik/Desktop/NEHA WORK/MASTERS SUBJECTS /COMPUTER SCIENCE/CS767/VC/data/out_samples'
            time.sleep(1)
